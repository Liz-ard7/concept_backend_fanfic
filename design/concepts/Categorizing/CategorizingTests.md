...
[@CategorizingImplementation](implementation.md)
...
[@ExampleOfTestsForImplementationWithoutMongoDB](../../../../intro-gemini-schedule/dayplanner-tests.ts)
That implementation doesn't use MongoDB, but yours should.
